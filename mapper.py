...
class SmartSafeMapper(Node):
    def __init__(self):
        ...
        # точно рабочие цифры
        self.safe_distance = 0.7  # метров до стены - начинаем поворачивать
        ...
        self.state = "EXPLORING"  # EXPLORING - едим, BACKING_UP-откат, TURNING-поворот
    ...
    def control_loop(self):
        ...
        if self.state == "EXPLORING":
            ...
            if self.backup_time >= 1.5:  # 1.5 секунды назад если потерялись или нет хорошего выбора по повороту
                self.state = "TURNING"
